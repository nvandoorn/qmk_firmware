...
[_LOWER] = LAYOUT_ortho_4x12(
  ...
  _______, _______,  _______, _______, _______, KC_BSPC, KC_MPRV, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_RAISE] = LAYOUT_ortho_4x12(
  ...
  _______, KC_COMM, KC_0,  KC_DOT, _______, KC_BSPC, KC_MPRV, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
